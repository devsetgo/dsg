...
ENV CREATE_DEMO_USER=False
ENV CREATE_BASE_CATEGORIES=False
ENV CREATE_DEMO_DATA=False
ENV CREATE_DEMO_NOTES=False
...
CMD uvicorn src.main:app --port $PORT --workers $WORKERS